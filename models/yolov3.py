...
class residual_block(nn.Module):
    def __init__(self, channel):
        ...
        self.conv_1x1 = convolution(in_channel=channel, out_channel=channel // 2, kernel_size=1, stride=1, padding=0,
                                    if_bn=True, if_activity=True)
        self.conv_3x3 = convolution(in_channel=channel // 2, out_channel=channel, kernel_size=3, stride=1, padding=1,
                                    if_bn=True, if_activity=True)
...
class darknet53(nn.Module):
    def __init__(self):
        ...
        self.conv_0 = convolution(in_channel=3, out_channel=32, kernel_size=3, stride=1, padding=1, if_bn=True,
                                  if_activity=True)
        self.conv_1 = convolution(in_channel=32, out_channel=64, kernel_size=3, stride=2, padding=1, if_bn=True,
                                  if_activity=True)
        self.conv_2 = convolution(in_channel=64, out_channel=128, kernel_size=3, stride=2, padding=1, if_bn=True,
                                  if_activity=True)
        self.conv_3 = convolution(in_channel=128, out_channel=256, kernel_size=3, stride=2, padding=1, if_bn=True,
                                  if_activity=True)
        self.conv_4 = convolution(in_channel=256, out_channel=512, kernel_size=3, stride=2, padding=1, if_bn=True,
                                  if_activity=True)
        self.conv_5 = convolution(in_channel=512, out_channel=1024, kernel_size=3, stride=2, padding=1, if_bn=True,
                                  if_activity=True)
